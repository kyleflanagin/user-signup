...
def make_form(values):
    form="""
    <form method="POST">
        <label style="color:blue; ">Username:
            <input style= "margin-left:41px" type="text" name="username" value="%(username)s" />
            <span class="error">%(username_error)s</span>
        </label>
        <br>

        <label style = "color:blue";>Password:
            <input style= "margin-left:44px" type="password" name="password" value="%(password)s" />
            <span class="error">%(password_error)s</span>
        </label>
        <br>

        <label style = "color:blue";>Verify Password:
            <input type="password" name="verify" value="%(verify)s" />
            <span class="error">%(verify_error)s</span>
        </label>
        <br>

        <label style = "color:blue"; >Email:
            <input style= "margin-left:67px" type="text" name="email" value="%(email)s" />
